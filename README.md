...
- Need Python installed, developed using [Python 3.11.9](https://www.python.org/downloads/release/python-3119/) (Could have issues with dependencies in fresh/newer versions)
...
- Program: path to the Python executable #NOTE: you can write this in terminal to find path to Python: where python
- Arguments: path to the script #NOTE: spaces in folders names causes issues, make sure the whole path has no spaces!
